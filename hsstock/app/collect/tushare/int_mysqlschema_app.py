...
def main():
    ...
    schemaArr = [
        ...
        #         "Dividend": sa.types.NVARCHAR(30),
        #         "Payout Ratio": sa.types.NVARCHAR(30),
        #         "EPS": sa.types.FLOAT,
        #         "EPS this Y": sa.types.NVARCHAR(30),
        #         "EPS next Y": sa.types.NVARCHAR(30),
        #         "EPS past 5Y": sa.types.NVARCHAR(30),
        #         "EPS next 5Y": sa.types.NVARCHAR(30),
        #         "Sales past 5Y": sa.types.NVARCHAR(30),
        #         "EPS Q/Q": sa.types.NVARCHAR(30),
        #         "Sales Q/Q": sa.types.NVARCHAR(30),
        #         "Outstanding": sa.types.NVARCHAR(30),
        #         "Float": sa.types.NVARCHAR(30),
        #         "Insider Own": sa.types.NVARCHAR(30),
        #         "Insider Trans": sa.types.NVARCHAR(30),
        #         "Inst Own": sa.types.NVARCHAR(30),
        #         "Inst Trans": sa.types.NVARCHAR(30),
        #         "Float Short": sa.types.NVARCHAR(30),
        #         "Short Ratio": sa.types.FLOAT,
        #         "ROA": sa.types.NVARCHAR(30),
        #         "ROE": sa.types.NVARCHAR(30),
        #         "ROI": sa.types.NVARCHAR(30),
        #         "CurrR": sa.types.FLOAT,
        #         "Quick R": sa.types.FLOAT,
        #         "LTDebt/Eq": sa.types.FLOAT,
        #         "Debt/Eq": sa.types.FLOAT,
        #         "Gross M": sa.types.NVARCHAR(30),
        #         "Oper M": sa.types.NVARCHAR(30),
        #         "Profit M": sa.types.NVARCHAR(30),
        #         "Perf Week": sa.types.NVARCHAR(30),
        #         "Perf Month": sa.types.NVARCHAR(30),
        #         "Perf Quart": sa.types.NVARCHAR(30),
        #         "Perf Half": sa.types.NVARCHAR(30),
        #         "Perf Year": sa.types.NVARCHAR(30),
        #         "Perf YTD": sa.types.NVARCHAR(30),
        #         "Beta": sa.types.FLOAT,
        #         "ATR": sa.types.FLOAT,
        #         "Volatility W": sa.types.NVARCHAR(30),
        #         "Volatility M": sa.types.NVARCHAR(30),
        #         "SMA20": sa.types.NVARCHAR(30),
        #         "SMA50": sa.types.NVARCHAR(30),
        #         "SMA200": sa.types.NVARCHAR(30),
        #         "50D High": sa.types.NVARCHAR(30),
        #         "50D Low": sa.types.NVARCHAR(30),
        #         "52W High": sa.types.NVARCHAR(30),
        #         "52W Low": sa.types.NVARCHAR(30),
        #         "RSI": sa.types.FLOAT,
        #         "from Open": sa.types.NVARCHAR(30),
        #         "Gap": sa.types.NVARCHAR(30),
        #         "Recom": sa.types.FLOAT,
        #         "Avg Volume": sa.types.NVARCHAR(30),
        #         "Rel Volume": sa.types.FLOAT,
        #         "Price": sa.types.FLOAT,
        #         "Change": sa.types.NVARCHAR(30),
        #         "Volume": sa.types.NVARCHAR(30),
        #         "Earnings": sa.types.NVARCHAR(30),
        #         "Target Price": sa.types.FLOAT,
        #         "IPO Date": sa.types.NVARCHAR(20)
        #     },
        #     "clauses": [
        ...
        #         'ALTER TABLE `{0}` MODIFY COLUMN icratio FLOAT COMMENT  \'利息支付倍数\';',
        #         'ALTER TABLE `{0}` MODIFY COLUMN sheqratio FLOAT COMMENT  \'股东权益比率\';',
        #         'ALTER TABLE `{0}` MODIFY COLUMN adratio FLOAT COMMENT  \'股东权益增长率\';'
        #     ]
        # },
        # {
        ...
        #         'ALTER TABLE `{0}` MODIFY COLUMN m1_yoy FLOAT COMMENT  \'货币(狭义货币M1)同比增长(百分比)\';'
        #         'ALTER TABLE `{0}` MODIFY COLUMN m0 FLOAT COMMENT  \'流通中现金(M0)(亿元)\';'
        #         'ALTER TABLE `{0}` MODIFY COLUMN m0_yoy FLOAT COMMENT  \'流通中现金(M0)同比增长(百分比)\';'
        #         'ALTER TABLE `{0}` MODIFY COLUMN cd FLOAT COMMENT  \'活期存款(亿元)\';'
        #         'ALTER TABLE `{0}` MODIFY COLUMN cd_yoy FLOAT COMMENT  \'活期存款同比增长(百分比)\';'
        #         'ALTER TABLE `{0}` MODIFY COLUMN qm FLOAT COMMENT  \'准货币(亿元)\';'
        #         'ALTER TABLE `{0}` MODIFY COLUMN qm_yoy FLOAT COMMENT  \'准货币同比增长(百分比)\';'
        #         'ALTER TABLE `{0}` MODIFY COLUMN ftd FLOAT COMMENT  \'定期存款(亿元)\';'
        #         'ALTER TABLE `{0}` MODIFY COLUMN ftd_yoy FLOAT COMMENT  \'定期存款同比增长(百分比)\';'
        #         'ALTER TABLE `{0}` MODIFY COLUMN sd FLOAT COMMENT  \'储蓄存款(亿元)\';'
        #         'ALTER TABLE `{0}` MODIFY COLUMN sd_yoy FLOAT COMMENT  \'储蓄存款同比增长(百分比)\';'
        #         'ALTER TABLE `{0}` MODIFY COLUMN rests FLOAT COMMENT  \'其他存款(亿元)\';'
        #         'ALTER TABLE `{0}` MODIFY COLUMN rests_yoy FLOAT COMMENT  \'其他存款同比增长(百分比)\';'
        #     ]
        # },
        # {
        ...
        # },
        {
            ...
            "dtype": {
                ...
                "distrib": sa.types.NVARCHAR(30),
                "report_date": sa.types.NVARCHAR(40)
            },
            "clauses": [
                'ALTER TABLE `{0}` ADD INDEX (`code`);',
                'ALTER TABLE `{0}` MODIFY COLUMN eps FLOAT COMMENT  \'每股收益\';',
                ...
                'ALTER TABLE `{0}` MODIFY COLUMN distrib VARCHAR(40) COMMENT  \'分配方案,如:10派3\';'
            ]
        },
        # {
        #     "table": "ts2_rrr",
